...
<Image img={require("/static/img/data-center/direct-to-chip1.png")} />
...
<Image img={require("/static/img/data-center/rear-door1.png")} />
...
<Image img={require("/static/img/data-center/immersions1.png")} />
